<template>
  <div>
      ...
      <div class="row">
        <div class="col-md-2 d-flex">
          <button
            ...
            v-on:click="showNewSubcategoryModal"
          >
              ...
              <tr v-for="(categorie, index) in categories" :key="index">
                ...
                <td class="pt-3">
                  {{
                    ...
                    categorie.subcategories.length
                  }}
                </td>
              </tr>
            </tbody>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="col-md-12 mt-5 categories-collaps">
              ...
              <b-button v-b-toggle="'collapse-c '">{{
                categories[2].name
              }}</b-button>
              ...
              <b-collapse id="collapse-a" class="collaps mt-2">
                ...
                <div>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr
                        v-for="subcategorie in categories[0].subcategories"
                        :key="subcategorie.id"
                      >
                        ...
                        <td>
                          <b-button
                            variant="danger"
                            @click="delete_subcategories(subcategorie)"
                          >
                            <i class="fas fa-trash-alt"></i>
                          </b-button>
                          <b-button
                            variant="success"
                            @click="updatesubcategorie(subcategorie)"
                          >
              ...
              <b-collapse id="collapse-b" class="collaps mt-2">
                <h2>
                  {{
                    categories[1].subcategories.length > 0
                      ? ""
                      : "la liste est vide"
                  }}
                </h2>
                <div>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr
                        v-for="subcategorie in categories[1].subcategories"
                        :key="subcategorie.id"
                      >
                        <th scope="row ">{{ subcategorie.id }}</th>
                        <td class="pt-3">{{ subcategorie.name }}</td>
              ...
              <b-collapse id="collapse-c" class="collaps mt-2">
                <h2>
                  {{
                    categories[2].subcategories.length > 0
                      ? ""
                      : "la liste est vide"
                  }}
                </h2>
                <div>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr
                        v-for="subcategorie in categories[2].subcategories"
                        :key="subcategorie.id"
                      >
                        <th scope="row ">{{ subcategorie.id }}</th>
                        <td class="pt-3">{{ subcategorie.name }}</td>
    ...
    <b-modal
      ref="NewSubcategoryModal"
      hide-footer
      title="Ajoute dune nouvelle categories"
    >
        ...
        <form v-on:submit.prevent="createSubcategory">
          <div class="form-group">
            ...
            <input
              ...
              id="name"
              name="name"
              placeholder="Entrer le nome du categorie"
            />
          ...
          <button
            ...
            v-on:click="hideNewSubcategoryModal"
          >
            Exit
          </button>
          <button
        ...
        <form v-on:submit.prevent="updatsubcategorie">
          <div class="form-group">
            ...
            <input
              ...
              id="name"
              name="name"
              placeholder="Entrer le nome du subcategorie"
            />
          </div>
          <hr />
          <button
            type="button"
            class="btn btn-default"
            v-on:click="hideEditSubcategoryModal"
          >
            Exit
          </button>
          <button
...
export default {
  ...
  created() {
    this.get_categories(), this.get_subcategories();
  },
  ...
  methods: {
    ...
    delete_subcategories(subcategorie) {
      this.$swal({
        title: "Are you sure?",
        ...
        if (result.isConfirmed) {
          this.delete_subcategorie(subcategorie.id);
